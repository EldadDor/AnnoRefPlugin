...
public class AnnoRefCreateClassDialog extends DialogWrapper {
	...
	private final String annoRefIDName;
	...
	private final DestinationFolderComboBox myDestinationCB = new DestinationFolderComboBox() {
		...
		protected boolean reportBaseInTestSelectionInSource() {
			return AnnoRefCreateClassDialog.this.reportBaseInTestSelectionInSource();
		}

		@Override
		protected boolean reportBaseInSourceSelectionInTest() {
			return AnnoRefCreateClassDialog.this.reportBaseInSourceSelectionInTest();
		}
	};
	@NonNls
	private static final String RECENTS_KEY = "AnnoRefCreateClassDialog.RecentsKey";

	public AnnoRefCreateClassDialog(@NotNull Project project,
	...
	public String getAnnoRefIDName() {
		return annoRefIDName;
	}
	...
	protected JComponent createNorthPanel() {
		...
		if (myClassNameEditable) {
			...
			final JBLabel labelIDInfo = new JBLabel("AnnoRef Query ID:");
			panel.add(labelIDInfo, gbConstraints);
			final JBLabel labelDText = new JBLabel(annoRefIDName);
			gbConstraints.gridx = 1;
			panel.add(labelDText, gbConstraints);
