...
//	private ProgressIndicator progressIndicator;
    ...
    public static ReferenceCollectionManager getInstance(VirtualFile vf) {
        return SQLRefApplication.getCurrentProjectReferenceCollectionManager(ProjectUtil.guessProjectForFile(vf));
    }

    public static FileReferenceCollection getFileReferenceCollectionByPsiFile(PsiFile psiFile) {
	    ReferenceCollectionManager referenceCollectionManager = SQLRefApplication.getCurrentProjectReferenceCollectionManager(ProjectUtil.guessProjectForFile(psiFile.getVirtualFile()));
	    return referenceCollectionManager.getQueriesCollection(psiFile.getName(), false);
    }
