...
public abstract class StringUtils {
	...
	/**
	 * Returns the word from the text gem. index
	 */
	@Nullable
	...
	/**
	 * Tests whether in begin / end a word begins and ends.
	 */
	...
	/**
	 * Check whether the character is a letter (no delimiter) (and thus resp. By a word is completed)
	 *
	 * @param currentChar character to be tested
	 * @return <tt>true</tt>, if it is a letter
	 */
	public static boolean isWordchar(char currentChar) {
