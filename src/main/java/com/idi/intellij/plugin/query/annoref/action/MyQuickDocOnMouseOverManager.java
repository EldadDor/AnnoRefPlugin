 ...
 */
public class MyQuickDocOnMouseOverManager {

	@NotNull
	private final EditorMouseMotionListener myMouseListener = new MyEditorMouseListener();
	@NotNull
	...
	@NotNull
	private final Runnable myRequest = new MyShowQuickDocRequest();
	@NotNull
	private final Runnable myHintCloseCallback = new MyCloseDocCallback();
	@NotNull
	private final Map<Document, Boolean> myMonitoredDocuments = new WeakHashMap<Document, Boolean>();
	...
	public MyQuickDocOnMouseOverManager(@NotNull Application application) {
...
//		documentationManager.fetchDocInfo();
